...
| `event.timestamp`  | required     | [ISO-8601](https://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) | Timestamp that indicates when the event happened. |
